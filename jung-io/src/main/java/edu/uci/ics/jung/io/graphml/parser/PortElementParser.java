 ...
 */
public class PortElementParser extends AbstractElementParser {

    final private KeyMap keyMap;
    
    public PortElementParser(ElementParserRegistry registry, KeyMap keyMap) {
        super(registry);
