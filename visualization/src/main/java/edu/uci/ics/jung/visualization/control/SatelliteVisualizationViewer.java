...
public class SatelliteVisualizationViewer<V, E> 
    ...
    public SatelliteVisualizationViewer(VisualizationViewer<V,E> master, Layout<V,E> layout, 
        ...
        this(master, new DefaultVisualizationModel<V,E>(layout), renderer);
    }
     ...
     * @param preferredSize
     */
    public SatelliteVisualizationViewer(VisualizationViewer<V,E> master, Layout<V,E> layout, Renderer<V,E> renderer,
            Dimension preferredSize) {
        this(master, new DefaultVisualizationModel<V,E>(layout, preferredSize), renderer, preferredSize);
    }
     ...
     */
    public SatelliteVisualizationViewer(VisualizationViewer<V,E> master, VisualizationModel<V,E> model,
            Renderer<V,E> renderer, Dimension preferredSize) {
