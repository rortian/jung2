...
public class GraphZoomScrollPane extends JPanel {
    protected VisualizationComponent vv;
     ...
     * @param vv
     */
    public GraphZoomScrollPane(VisualizationComponent vv) {
        ...
        vv.addChangeListener(
            ...
            public void stateChanged(ChangeEvent evt) {
                VisualizationComponent vv = 
                    (VisualizationComponent)evt.getSource();
                setScrollBars(vv);
            }
        });
        add(vv);
     ...
     */
    private void setScrollBars(VisualizationComponent vv) {
        Dimension d = vv.getGraphLayout().getSize();
