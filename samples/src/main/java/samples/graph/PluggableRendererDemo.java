 ...
 */
public class PluggableRendererDemo<V, E extends Edge<V>> extends JApplet implements ActionListener 
{
...
//	protected static final int GRADIENT_ABSOLUTE = 2;
    ...
    protected PluggableRenderer<V,E> pr;
    ...
    protected Map<Edge,Number> edge_weight = new HashMap<Edge,Number>();
//    	new UserDatumNumberEdgeValue("edge_weight");
    protected Map<V,Number> voltages = new HashMap<V,Number>();
//    	new UserDatumNumberVertexValue(VOLTAGE_KEY);
    protected Map<V,Number> transparency = new HashMap<V,Number>();
//    	new UserDatumNumberVertexValue(TRANSPARENCY);
    ...
    public JPanel startFunction() {
        ...
        pr = new PluggableRenderer<V,E>();
        Layout<V,E> layout = new FRLayout<V,E>(g);
        vv = new VisualizationViewer<V,E>(layout, pr);
        // add Shape based pick support
        vv.setPickSupport(new ShapePickSupport<V,E>());
    ...
    public Graph getGraph()
    {
        ...
        Collection<V> seeds = g.getVertices();
...
//            V v = iter.next();
        ...
        V v = verts.iterator().next(); 
        Edge e = new DirectedSparseEdge(v,v);
        edge_weight.put(e, new Double(Math.random()));
        g.addEdge(e);
...
//			}
    ...
    private final class SeedColor implements VertexPaintFunction<V>
    {
    ...
    private final static class EdgeWeightStrokeFunction<E extends Edge>
    ...
    private final static class VertexStrokeHighlight<V, E extends Edge<V>> implements VertexStrokeFunction<V>
    {
...
//                        Vertex w = (Vertex)iter.next();
    ...
    private final static class FontHandler<V, E extends Edge<V>> 
    	implements VertexFontFunction<V>, EdgeFontFunction<E>
    {
    ...
    private final static class VertexDisplayPredicate<V, E extends Edge<V>> implements Predicate<V>
    {
...
//            Vertex v = (Vertex)arg0;
     ...
     */
    private final static class VertexShapeSizeAspect<V, E extends Edge<V>>
    ...
    protected class PopupGraphMousePlugin extends AbstractPopupGraphMousePlugin
        ...
        protected void handlePopup(MouseEvent e) {
            ...
            if(pickSupport != null) {
                final V v = pickSupport.getVertex(p.getX(), p.getY());
                if(v != null) {
...
//                            value.setDoubleValue(Math.max(0, value.doubleValue() - 0.1));
    ...
    public class GradientPickedEdgePaintFunction extends GradientEdgePaintFunction<V,E> 
    {
        ...
        public GradientPickedEdgePaintFunction( EdgePaintFunction<E> defaultEdgePaintFunction, HasGraphLayout vv, 
